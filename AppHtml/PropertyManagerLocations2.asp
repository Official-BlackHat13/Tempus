...
<html>
    ...
    <body topmargin="5" leftmargin="5">
        ...
        %>
            ...
            <h3>Property Manager Locations</h3>
            ...
            <% If EndRowId <> "" Then %>
                <a href="PropertyManagerLocations2.asp?RunReport=1&Start=<% =EndRowId %>&Index=<% =Index %>">Next Page</a>
            <% End If %>

            <br />
            <a href="PropertyManagerLocations2.asp">New Report</a>

        <% Else  '-------------set up the report ------------- %>

            <h3>Property Manager Locations</h3>

            <form action="PropertyManagerLocations2.asp" method="get">
                <blockquote>
