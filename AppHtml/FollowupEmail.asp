                    ...
                    <div>
                        <table class="EntryTable">
                            <tr>
                             ...
                             <tr>
                                <td class="Label"></td>
                                <td><input name="Customer__Name" type="text" class="Data" title="Customer Name" value="" size="60" vdfNoEnter="True" /></td>
                            </tr>                         
                            <tr>
                                <td class="Label">Property Manager</td>
                                <td>
                                    <input name="Locnotes__MgrFirstName" type="text" class="Data" title="Contact FirstName" value="" size="30" vdfNoEnter="True" />
                                    <input name="Locnotes__MgrLastName" type="text" class="Data" title="Contact LastName" value="" size="30" vdfNoEnter="True" />
                                </td>
                            </tr>    
                            <tr>
                                <td class="Label"></td>
                                <td><input name="Locnotes__MgrEmailAddress" type="text" class="Data" title="Contact Email Address" value="" size="60" vdfNoEnter="True" /></td>
                            </tr>                   
                    
                            <tr>
                                <td class="Label">Caller Name</td>
                                <td><input class="Data" type="text" value="" name="Locnotes__CallerName" title="Caller Name" size="60"vdfNoEnter="True" /></td>
                            </tr>
                            <tr>
                                <td class="Label"></td>
                                <td>
                                    <input class="Data" type="text" value="" name="Locnotes__CallerEmail" title="Caller Email" size="60" />
                                </td>
                            </tr>
                            <tr>
                                <td class="Label">Note Number</td>
                                <td>
                                    <input class="Data" type="text" value="" name="Locnotes__LocnotesId" title="Locnotes ID" size="8" vdfSuggestSource="find" vdfNoEnter="True" />
                                </td>
                            </tr>
                            <tr>
                                <td class="Label">Customer Request</td>
                                <td class="Data"><textarea class="text_data" name="Locnotes__Note" cols="70" rows="3" title="Entered Message" vdfNoEnter="True"></textarea></td>                                
                            </tr>
                            <tr>
                                <td class="Label">Subject</td>
                                <td><input class="Data" type="text" value="" name="Locnotes__EmailSubject" title="Subject" size="60"></td>
                            </tr>
                            <tr>
                                <td class="Label">Email</td>
                                <td class="Data"><textarea class="text_data" name="Locnotes__EmailReply" cols="70" rows="5" title="Email Message"></textarea></td>                                
                            </tr>
