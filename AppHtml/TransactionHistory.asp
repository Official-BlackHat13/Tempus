    ...
    <body topmargin="5" leftmargin="5">
        ...
        %>
            ...
            <% 
                ...
                oTransactionHistory.Call "Msg_SetTrans_Jobnumber", SelStart1, SelStart1
                oTransactionHistory.Call "Msg_SetTrans_Startdate", SelStart2, SelStop2

                EndRowId = oTransactionHistory.Call ("Get_RunTransactionHistory", Index, StartRowId, MaxRecs)
            %>
            <% If StartRowId <> "" Then %>
            ...
            <% If EndRowId <> "" Then %>
                <a href="TransactionHistory.asp?RunReport=1&Start=<% =EndRowId %>&Index=<% =Index %>&SelStart1=<% =SelStart1 %>&SelStop1=<% =SelStop1 %>&SelStart2=<% =SelStart2 %>&SelStop2=<% =SelStop2 %>">Next Page</a>
            <% End If %>

            <br />
            <a href="TransactionHistory.asp">New Report</a>

        <% Else  '-------------set up the report ------------- %>

            <h3>Transaction History</h3>

            <form action="TransactionHistory.asp" method="get">
                <blockquote>
