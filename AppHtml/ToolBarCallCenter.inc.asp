            ...
            <table class="Toolbar" vdfControlType="vdf.core.Toolbar" vdfName="main_toolbar" cellpadding="0" cellspacing="0"> 
                ...
                <% If (bEditRights) Then %>
                    ...
                    <td class="ButtonCell"><input id="Delete" class="NavigationButton" type="button" name="delete" value="" onclick="vdf.core.findForm(this).doDelete();" title="Close (Shift - F2)" /> </td>
                    <td>&nbsp;</td>
                    <% End If %>
                <% End If %>
				</tr>
