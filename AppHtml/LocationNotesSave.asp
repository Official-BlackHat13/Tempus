...
<!-- #INCLUDE FILE="toolbarnofind.inc.asp" -->
        ...
        <table>
            <tr>
                <td>Jobnumber</td>
                <td>
                    <input name="Order__Jobnumber"  style="width:8em;" />
                    <input Class="LookupButton" type="button" title="List of all records" tabindex="-1" vdfControlType="lookupdialog" vdfWebObject="oLocationNotes" vdfLookupTable="Order" vdfLookupFields="order__jobnumber" />
