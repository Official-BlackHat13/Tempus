...
<% '
    ...
    ZoomURL = "OpenTransactionsZoom.asp" ' name of zoom file. If blank none.
    RunReport = (Request ("RunReport") <> "")
    Index = 5' This Report uses a Fixed finding index
%>
...
<html>
    ...
    <body topmargin="5" leftmargin="5">
        ...
        %>
            ...
            <% If EndRowId <> "" Then %>
                <a href="OpenTransactions.asp?RunReport=1&Start=<% =EndRowId %>&Index=<% =Index %>&SelStart1=<% =SelStart1 %>&SelStop1=<% =SelStop1 %>">Next Page</a>
            <% End If %>
