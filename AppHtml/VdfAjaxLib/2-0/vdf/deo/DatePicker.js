...
/*
Data bound inline calendar control that uses the vdf.gui.Calendar control. The 
calendar is displayed inside the div element and binds itself to the given data
binding.

@code
<div vdfControlType="vdf.deo.DatePicker" vdfDataBinding="orderhea__order_date">
</div>
@code
*/
