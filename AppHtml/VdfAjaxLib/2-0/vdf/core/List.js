...
vdf.core.List = function List(eElement, oParentControl){
    ...
    //  Main references
    /*
    Reference to the DOM element of the table.
    */
    this.eElement = eElement;
    /*
    Reference to the parent control (in which this control is nested).
    */
    this.oParentControl = oParentControl;
    /*
    Reference to the Form object to which the List belongs.
    */
    this.oForm = null;
    ...
    */
    ...
    /*
    If true the header fields are automatically filled with the shortlabel DD 
    setting or with the field name.
    */
...
/*
Performs the autolabeling if bAutoLabel is true. The header elements are field 
objects (usually vdf.deo.DOM) which have the label as a value. We always use 
the shortlabel of the data dictionary. If none is set we use the data binding.
*/
...
@param  oField      Field control.
    bReversed   (optional) If true the index will be used in reverse order. If 
...
/*
Selects the row which contains the given DOM element.
