...
/*
Contains the functionallity to generate lookups based on a list of fields. It 
attaches itself to data entry fields so it can be opened using the lookup key 
(usually F4).
*/
