...
vdf.gui.Calendar = function(eElement, oParentControl){
    ...
    /*
    Reference to the DOM element (the element from which the HTML attributes are 
    read, the eContainerElement can be different).
    */
...
/*
Calendar component that contains the functionality to display a day selection 
calendar. The calendar has several navigation options and is used throughout the 
system.
*/
...
/*
Destroys the calendar by removing all the event listeners and other DOM 
references.
*/
destroy : function(){
    var iChild;
