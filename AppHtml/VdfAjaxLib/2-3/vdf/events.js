...
function myInitForm(oForm){
    vdf.events.addDomListener("click", document.getElementById("mybutton"), myButtonClick);
}
...
/*
The vdf.events.JShandler class contains the logic that is used to throw AJAX 
...
function listener1(oEvent){
    ...
    vdf.gui.alert("Hello " + oEvent.sPersonName);
...
function listener2(oEvent){
    vdf.gui.alert("This method should never be called..");
}

//  Create event object
var myEvent = new vdf.events.JSHandler();
...
/*
Constructor of the vdf.events.JSEvent class which takes two parameters.
...
AJAX Library event system. See vdf.events.JSHandler for an example of how this 
