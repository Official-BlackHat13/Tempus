...
/*
This method augments the deselect function with the autosave check and edit row functionality. 

@return True if the row successfully deselected.
*/
deSelect : function(){
...
/*
Stores the reference to the action function and the arguments and sets bSaveAction to true. Then it 
calls the action function which will usually call the deSelect function that checks if a save should 
be done because bSaveAction is true and can call the action function again if the save completed 
successfully.

@param  fSaveAction     Reference to the action function (like scrollUp).
@param  aSaveArguments  The arguments array with the arguments for calling the action function.
