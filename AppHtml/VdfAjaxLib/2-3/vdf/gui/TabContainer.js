...
/*
Switches to the tab with the name provided.

@param  sName   Name of the tab to display.
@param  bFocus  (optional) If true the first focusable element in the tab receives the focus.
@return True if successful (tab does exist).
*/
...
/*
This method switches to the tab that contains the provided element. It will bubble up in the DOM to 
find the tab page.
...
@return True if successful, false if the element wasn’t part of one of the tab pages.
