...
@code
    ...
    */
    ...
    @prop   sPrevValue  The previous value of the field.
    */
...
/*
Determines a global meta property that can be set in the HTML or comes from the meta data object.

@param  sProp       The name of the property.
@param  sDefault	Default value.
@param  bBubble	    (optional) True if the property value may be inherited.
...
/*
This method performs a client-side validation on this field. It will use all validation properties 
available on the client and it fires the onValidate event for custom validations.

@param  bWaitAutoFind   If true the find required (bFindReq) won't be validated because the auto 
                        find might still be processing.
@return 0 if no validation errors occurred, 1 if the onValidate event was stopped.
*/
