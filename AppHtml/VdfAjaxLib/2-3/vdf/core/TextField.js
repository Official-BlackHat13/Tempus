...
/*
Parses the date from the string into a Date object which allows easy manipulation and calculation.

@param  sVal	The string containing the date.
@returns Date object containing the date.
@private
*/
...
/*
This method generates a string from the date object using the configured date format and date 
separator.

@param  dVal	The date object.
...
/*
This method allows a numeric value to be set to the field without converting it to a string first. 
It uses the configured decimal separator to convert the number into a string.

@param  nVal            The new numeric value.
@param  bNoNotify       (optional) If true the DD is not updated with this change.
@param  bResetChange    (optional) If true the display changed is cleared.
*/
...
/*
This method returns the value as a number so it can be used in calculations right away. 

@return Number representing the field value.
*/
getNumber : function(){
...
/*
This method allows a date value (Date object) to be set to the field without converting it to a string first. It uses the configured date format and date separator to convert the number into a string.

@param  dVal            The new date value.
@param  bNoNotify       (optional) If true the DD is not updated with this change.
@param  bResetChange    (optional) If true the display changed is cleared.
*/
...
/*
This method returns the value as a date object so it can be used in calculations right away. Note that the sDataFormat should be set to "date" to use this method properly.

@return Date object representing the current field value.
*/
getDate : function(){
