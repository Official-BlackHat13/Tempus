...
/*
This method performs a find by rowid. It will call the doFindByRowId method of the 
ClientDataDictionary object that belongs to the passed table name.

@param  sTable  The name of the table.
@param  sRowId  String containing the serialized rowid.
@return True if the findByRowId action successfully send to the server.
*/
...
/*
This method will perform a delete operation. The doDelete method of the ClientDataDictionary object 
will be called. If no table name is passed the server DD will be used. 

@param  sTable  (optional) Table to perform the delete on.
@return True if delete was successfully send to the server.
*/
