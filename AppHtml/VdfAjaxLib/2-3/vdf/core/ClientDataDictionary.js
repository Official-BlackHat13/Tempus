...
/*
This method locks the data dictionary by incrementing the counter. Optionally the bLockedExclusive 
property will be set as well. 

@param  bExclusive  If true the lock will be exclusive.
@param  oAction     The action object that performs the lock.
@return True if the DD is successfully locked.
@private
*/
