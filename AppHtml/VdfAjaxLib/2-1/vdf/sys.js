...
eElement    Reference to a DOM element.
*/
...
/*
Fades the opacity of the element to the given percentage in the given amount of
time.

@private
@param  eElement        Reference to the DOM element.
@param  iGoal           Goal opacity percentage.
@param  iMillis         Duration of the fade in milliseconds.
@param  fFinished       (optional)Function to call when finished.
@param  oEnvironment    (optional)Environment for fFinished function.
*/
...
/*
Stops an opacity fade in progress on the given element.
...
/*
Fades the color of the element to the given color in the given amount of time.
It can fade any color property of the element.
@private

@param  eElement        Reference to the DOM element.
@param  sGoal           Color string of the goal color.
@param  sCSSProp        Name of the CSS property to fade (for example
...
/*
Stops a color fade in progress on the element.
@private
@param  eElement    Reference to the dom element.
*/
...
/*
Name:
    vdf.sys.StringBuilder
Type:
    Prototype

Revisions:
    2008/01/04  Updated the stringbuilder to the 2.0 structure. (HW, DAE)
    2007/08/23  Created the prototype. (EvdV, DAE)
*/


/*
Constructor that initializes the string array.

@param  sValue  The initial string.
*/
...
/*
Should be used when building long strings to optimize performance in specific 
browsers. It stores all parts of the string in an array and uses the Array.join 
method to concatenate the strings at the end.
*/
...
/*
Adds the given value to the beginning of the string.
