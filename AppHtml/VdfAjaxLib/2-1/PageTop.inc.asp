<%  
    ...
    sAjaxTheme = "2-1"      '   Defines the theme that is used (is actually a folder name AppHTML\CSS\VdfAjaxLib)
    sAjaxLanguage = "en"    '   Defines the language that is used (defines which file from AppHTML\VdfAjaxLib\2-1\vdf\lang is used)
    ...
    '   AJAX LIBRARY 2.1 REQUIRES THE STRICT DOCTYPE!!
%>
