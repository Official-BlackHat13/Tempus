...
Object oTransactions is a cTempusDbView
    ...
    Property Number  pnBulkTotal
    Property Number  pnBagTotal
    ...
    Object oEmployeeContainer is a dbContainer3d
        ...
        Object oEmployee_EmployeeIdno is a dbForm
            ...
            Procedure Refresh Integer notifyMode
                ...
                Boolean bHasEmplRec bICEmployer bHasSysAdminRights
...
//                    Send Beginning_of_Data of oTransactionGrid
    ...
    Object oTransCJDBGrid is a cDbCJGrid
        ...
        Object oTrans_TransIdno is a cDbCJGridColumn
            ...
            Set piDisabledTextColor to clLtGray
        End_Object
            ...
            Procedure OnSetDisplayMetrics Handle hoGridItemMetrics Integer iRow String  ByRef sValue
                ...
                Case Begin
                    Case (iVendInvoiced = 1)
                        Set ComForeColor of hoGridItemMetrics to clLtGray
                        //Set pbFocusable of Self to False
        ...
        Object oTrans_StartDate1 is a cDbCJGridColumn
        ...
        Object oTrans_StopDate1 is a cDbCJGridColumn
        ...
        Object oTrans_PrevOverlap is a cDbCJGridColumn
            ...
            Procedure OnSetCalculatedValue String  ByRef sValue
                ...
                //Get HasPrevOverlappingTrans to sValue
            End_Procedure
        End_Object
        ...
        Object oTrans_NextOverlap is a cDbCJGridColumn
            ...
            Procedure OnSetCalculatedValue String  ByRef sValue
                Forward Send OnSetCalculatedValue (&sValue)
                //Get HasNextOverlappingTrans to sValue
            End_Procedure
        End_Object        
        ...
        Function HasPrevOverlappingTrans DateTime dtC Returns Boolean
            Boolean bOverlapping
            Integer iTransIdno iEmployeeIdno
            DateTime dtCurr dtPrev
            //
            //Compare to Previous
            ...
            //
            Move Trans.StartDate to dtCurr
            Move (DateSetHour(dtCurr, Trans.StartHr)) to dtCurr
            Move (DateSetMinute(dtCurr, Trans.StartMin)) to dtCurr
            Find LT Trans by Index.3
            While ((Found) and Trans.EmployeeIdno = iEmployeeIdno and dtPrev="")
                Relate Trans
                If (not(MastOps.CostType = "Material" or MastOps.CostType="PerTime")) Begin
                    Move Trans.StopDate to dtPrev
                    Move (DateSetHour(dtPrev, Trans.StopHr)) to dtPrev
                    Move (DateSetMinute(dtPrev, Trans.StopMin)) to dtPrev
                    //
                    Move (dtCurr<dtPrev) to bOverlapping
                End
                Else Begin
                    Find LT Trans by Index.3
                End
        ...
        Function HasNextOverlappingTrans Returns Boolean
            Boolean bOverlapping
            Integer iTransIdno iEmployeeIdno
            DateTime dtCurr dtNext
            //Compare to Following
            // Find Following Trans of this Employee, StartDate & Time has to be LE StopDate & time of Current Trans
            Move Trans.TransIdno to iTransIdno
            Move Trans.EmployeeIdno to iEmployeeIdno
            //
            Move Trans.StopDate to dtCurr
            Move (DateSetHour(dtCurr, Trans.StopHr)) to dtCurr
            Move (DateSetMinute(dtCurr, Trans.StopMin)) to dtCurr
            Find GT Trans by Index.3
            While ((Found) and Trans.EmployeeIdno = iEmployeeIdno and dtNext="")
                Relate Trans
                If (not(MastOps.CostType = "Material" or MastOps.CostType="PerTime")) Begin
                    Move Trans.StartDate to dtNext
                    Move (DateSetHour(dtNext, Trans.StartHr)) to dtNext
                    Move (DateSetMinute(dtNext, Trans.StartMin)) to dtNext
                    //
                    Move (dtCurr>dtNext) to bOverlapping
                End
                Else Begin
                    Find GT Trans by Index.3
                End
...
////                Boolean bRetVal bValid
////                Integer iJobNumber iLocIdno iAltJobNumber
////                String sErrorMsg
////                Handle hoDD
////                //
////                Get Server to hoDD
////                Get Field_Current_Value of hoDD Field Trans.JobNumber to iJobNumber 
////                Get IsJobValid of oOrder_DD iJobNumber (&iLocIdno) (&iAltJobNumber) (&sErrorMsg) to bValid
////                If (not(bValid)) Begin
////                    Send Stop_Box sErrorMsg "Validation Error"
////                    Function_Return True
////                End
////                
...
////                Handle hoDD
////                Integer iOpersIdno iCEPMEqipIdno iAttachmentIdno iAttachOpersIdno iAttachMastOps iEmployerIdno
////                String sErrorMsg sAttachmentCat
////                Boolean bSuccess bChanged bAttachReq bOK
////                //
////                Get Server to hoDD
////                //
////                Get Field_Changed_State of hoDD Field Trans.EquipIdno to bChanged
////                Get IsEquipmentValid Location.LocationIdno sNewValue to iOpersIdno
//////                Get IsEquipmentValid of oEquipmnt_DD Location.LocationIdno sNewValue (&iOpersIdno) (&iCEPMEqipIdno) sErrorMsg to bSuccess
////                If (iOpersIdno<>0) Begin
////                    Move iOpersIdno to Opers.OpersIdno
////                    Send Request_Find of hoDD EQ Opers.File_Number 1
////                End
////                Forward Send OnEndEdit sOldValue sNewValue                
////                // Prompt for attachment if needed
////                Move (MastOps.NeedsAttachment <> "NONE") to bAttachReq
////                Move MastOps.NeedsAttachment to sAttachmentCat
////                If (bChanged and bAttachReq) Begin
////                    Clear MastOps
////                    Move sAttachmentCat to MastOps.IsAttachment
////                    Find GE MastOps by Index.6
////                    If ((Found) and MastOps.CostType = "Attachment") Begin
////                        Move Equipmnt.OperatedBy to iEmployerIdno
////                        Get DoAttachPromptwEmployer of Equipmnt_sl (&iAttachmentIdno) iEmployerIdno sAttachmentCat to bOk
//////                        Get AttachmentSelection of Equipmnt_sl iEmployerIdno sAttachmentCat to iAttachmentIdno
////                        Get isAttachmentValid Location.LocationIdno iAttachmentIdno (&iAttachOpersIdno) (&iAttachMastOps) (&sErrorMsg) to bOk
////                        If (bOk) Begin                                            
////                            Set Field_Changed_Value of hoDD Field Trans.AttachEquipIdno to iAttachmentIdno
////                            Set Field_Changed_Value of hoDD Field Trans.AttachOpersIdno to iAttachOpersIdno
////                            Set Field_Changed_Value of hoDD Field Trans.AttachMastOpsIdno to iAttachMastOps
...
//            End
//            Else Begin
//                Move "Equipment# not found - try again or lookup" to sErrorMsg
//                Function_Return (False)
//            End
//            
//        End_Function
