    ...
    Object oContactContainer is a dbContainer3d
        ...
        Object oContact_ContactIdno is a dbForm
            ...
            Procedure Refresh Integer notifyMode
                ...
                Set Enabled_State of oChangeUserNameButton to (bHasWebAppUserRecord)
...
//                    End
    ...
    Object oContactTabDialog is a dbTabDialog
        ...
        Object oServiceCenterTabPage is a dbTabPage
            ...
            Object oChangeUserNameButton is a Button
                Set Size to 14 62
                Set Location to 55 3
                Set Label to 'Change Username'
            
                // fires when the button is clicked
                Procedure OnClick
                    String sUserName
                    Move (Trim(WebAppUser.LoginName)) to sUserName
                    Get PopupUserInput of oUserInputDialog "Change Username" "Please change username." sUserName False to sUserName
                    Reread WebAppUser
                    ...
                    Send Info_Box ("The username has been changed to:"*sUserName)
                End_Procedure
            ...
            Object oPrintGroup is a Group
                ...
                Object oServiceContactButton is a Button
                    ...
                    Procedure OnClick
                        ...
                        Get DoExportReport of oPropertyManagerServiceContactReportView Contact.ContactIdno (&sExportFileName) True to bSuccess
                    End_Procedure
                ...
                Object oiPhoneInstructionsButton is a Button
                    ...
                    Procedure OnClick
                        ...
                        Get DoExportReport of oPropertyManagerPhoneInstructions_iPhoneReportView (&sExportedFileName) True to bSuccess
                    End_Procedure
                ...
                Object oAndroidInstructionsButton is a Button
                    ...
                    Procedure OnClick
                        ...
                        Boolean bSuccess
                        String sExportedFileName
                        Get DoExportReport of oPropertyManagerPhoneInstructions_AndroidReportView (&sExportedFileName) True to bSuccess
                    End_Procedure
            ...
            Object oEmailGroup is a Group
                Set Size to 58 100
                Set Location to 73 110
                Set Label to 'Email'

                Object oButton1 is a Button
                    Set Size to 14 86
                    Set Location to 9 7
                    Set Label to 'All Instructions'
                    ...
                    Procedure OnClick
                        ...
                        Boolean bSuccess
                        //
                        Move Contact.ContactIdno to iPropMgrIdno
                        If (iPropMgrIdno<>0) Begin
                            tEmail eMessage
                            // Create and Prep both files
                            //ATTACHMENTS
                            Get DoExportReport of oPropertyManagerServiceContactReportView iPropMgrIdno (&eMessage.sAttachmentFilePath[0]) False to bSuccess
                            Get DoExportReport of oPropertyManagerPhoneInstructions_AndroidReportView (&eMessage.sAttachmentFilePath[1]) False to bSuccess
                            Get DoExportReport of oPropertyManagerPhoneInstructions_iPhoneReportView (&eMessage.sAttachmentFilePath[2]) False to bSuccess
                            //
                            //FROM
                            Move "no-reply@interstatepm.com" to eMessage.sFromEmail
                            //TO
                            Move (Trim(Contact.FirstName*Contact.LastName)) to eMessage.stToEmail[0].sFriendlyName
                            Move (Trim(Contact.EmailAddress)) to eMessage.stToEmail[0].sEmailAddress
                            //BCC
                            ...
                            //SUBJECT
                            Move "Interstate Companies - Property Service Contact " to eMessage.sSubject
                            //BODY
                            Append sHTMLMsg ("Hello"*(Trim(Contact.FirstName))+","+Character(10)+Character(10))
                            Append sHTMLMsg ("Thank you for being a customer to Interstate Companies."+Character(10)+Character(10))
                            Append sHTMLMsg ("Please see the attached PDF files to become familiar with your site service contact."+Character(10))
                            Append sHTMLMsg (">>>Beware the files may contain personalized credentials and shall not be shared with others.<<<"+Character(10)+Character(10))
                            Append sHTMLMsg ("Please feel free to contact me If you have any questions."+Character(10)+Character(10))
                            Append sHTMLMsg ("Kristin Larson."+Character(10))
                            Append sHTMLMsg ("651-361-8615 | kristin@interstatepm.com ")
