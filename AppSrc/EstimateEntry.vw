...
Object oEstimateEntry is a cTempusDbView
    ...
    Set Size to 120 500
    Set Location to 24 31
    Set Label to "Estimate Entry"
    Set piMinSize to 120 500
    ...
    Object oPrintButton is a Button
       ...
       // Set peAnchors to anBottomRight
        ...
        Procedure OnClick
            ...
            Integer iId
            //
            Get Field_Current_Value of oQuotehdr_DD Field Quotehdr.QuotehdrID to iId
            Get Confirm ("Print Estimate" * String(iId) + "?")                to bCancel
            If (not(bCancel)) Begin
                Send DoJumpStartReport of oCustomerEstimate iId
            End
        End_Procedure
    End_Object
    
//     Object oPrintProductionButton is a Button
//        Set Size to 14 80
//        Set Location to 112 287
//        Set Label to "Print Production Plan"
//        Set peAnchors to anBottomRight
//    
//        Procedure OnClick
//            Boolean bCancel
...
//            //
//            Get Field_Current_Value of oQuotehdr_DD Field Quotehdr.QuotehdrID to iId
//            Get Confirm ("Print Job Plan" * String(iId) + "?")                to bCancel
//            If (not(bCancel)) Begin
//               Send DoJumpStartReport of PrintJobSpecs iId
//            End
//        End_Procedure
//    End_Object
...
//            Integer iId
//            Get Field_Current_Value of oQuotehdr_DD Field Quotehdr.QuotehdrID to iId
//            Get Confirm ("STOP - CREATE ORDER" * String (iId) + "?") to bCancel
////            Include_Resource (not (bCancel)) Begin
//            Send DoCreateOrder
//    //        End            
//        End_Procedure    
//    End_Object
...
//    End_Object
    ...
    Procedure DoCalcEngine
        ...
        If (iStatus = DF_FILE_ACTIVE and Escomp.ESTIMATE_ID = Quotehdr.QuotehdrID) Begin
            Send DoSpecifications of oComponentItemDialog Escomp.Recnum False True //1st boolean = bLocked, 2nd = bTrigger
...
//            End
//            //
//            //Send DoCreatePMInvoice // expectation is this will get moved as procedure gets more complex
//            //
//        End
//        Send Activate of oQuotehdr_QuotehdrID
//    End_Procedure
...
//        Integer iRecId iErrors iCreated
//        Get DoCreatePMInvoiceFromQuote of oPMInvoiceFromQuote Quotehdr.Recnum  False to iRecId  // True = use quotedtl table as line item source, false = use esitem
...
//    End_Procedure
    ...
    Object oQuotehdr_QuotehdrID is a cGlblDbForm
        ...
        Procedure Refresh Integer iMode
            ...
            //
//Cergol calc wizard version can't coexist with Paradigm version //Set Enabled_State of oQuoteWizardButton to (Quotehdr.Recnum = 0)
            ...
            //Set Enabled_State of oQuotehdr_QuoteLostMemo to (not(bQuoteIsJob))
